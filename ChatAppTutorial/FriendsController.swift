...
//  ChatAppTutorial
//
//  Created by Shaun Bevan on 10/31/17.
//  Copyright © 2017 shaunbevn. All rights reserved.
//
...
class FriendCell: BaseCell {
    ...
    override func setupViews() {
        ...
        profileImageView.image = #imageLiteral(resourceName: "zuckprofile")
        hasReadImageView.image = #imageLiteral(resourceName: "zuckprofile")
